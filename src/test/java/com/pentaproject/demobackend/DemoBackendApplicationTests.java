...
class DemoBackendApplicationTests {
    ...
    public void insertValueDB(){
       Enemy EnemyTemp =  this.service.generateEnemy("ProvaFinale2",29,28,2,40,new ArrayList<>(), EnemyType.Tank);
    ...
    public void insertValueAndDeleteDB(){
        Enemy EnemyTemp =  this.service.generateEnemy("TestSalvataggioDatiAndDeleteSupremoDellaVita",29,28,2,40,new ArrayList<>(), EnemyType.Tank);
        enemyRepository.deleteByName(EnemyTemp.getName());
        try {
    ...
    public void TestGetParty() throws IOException, InterruptedException {
        ...
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create("http://localhost:8080/api/v1/0/party")).build();
    ...
    public void TestInsertParty() throws IOException, InterruptedException {
        ...
        String payload = "{\"id\":243423,\"Party\":{\"Members\":[{\"id\":2234,\"name\":\"ARCH\",\"ATT\":10,\"DEF\":5,\"HP\":50,\"MANA\":25},{\"id\":3322,\"name\":\"MELEE\",\"ATT\":20,\"DEF\":20,\"HP\":50,\"MANA\":25}],\"Bag\":[{\"id\":2434211113,\"Name\":\"Healingpotion\",\"Type\":\"HP\",\"Value\":10,\"Quantity\":2},{\"id\":212312343423,\"Name\":\"Manapotion\",\"Type\":\"MANA\",\"Value\":5,\"Quantity\":10}]}}";
