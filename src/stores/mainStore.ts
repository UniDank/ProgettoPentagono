...
export const useMainStore = defineStore('main', () => {
    ...
    const party = ref<Player[]>([ 
        new Player(Characters[0], 5, 5, 12, 10, 10, 10, ClassType.Melee), 
        new Player(Characters[1], 5, 7, 10, 10, 10, 10, ClassType.Mage), 
        new Player(Characters[2], 5, 6, 11, 10, 10, 10, ClassType.Thief), 
        new Player(Characters[3], 5, 3, 14, 10, 10, 10, ClassType.Archer), 
        new Player(Characters[4], 5, 15, 18, 10, 10, 10, ClassType.Tank) 
    ])
