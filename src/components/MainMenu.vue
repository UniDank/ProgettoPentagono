<template>
    <div class="rpgui-content">
        <div v-if="currentMenu == 0" class="fixed top-1/2 left-0 pl-8 translate-y-[-25%] rpgui-container">
            ...
            <div class="flex gap-4">
                ...
                <div class="flex flex-col">
                    ...
                    <select class="text-lg rpgui-dropdown lg:text-2xl rpgui-cursor-point">
                        ...
                        <option value="1024x768" selected class="text-lg !rpgui-cursor-point lg:text-2xl">1024 x 768</option>
                        <option value="720x576" class="text-lg !rpgui-cursor-point lg:text-2xl">720 x 576</option>
                    </select>
                </div>
            </div>
            <div class="flex gap-4">
...
<script setup lang="ts">
    ...
    function goBack() {
        if (boot.afterScene != 'BootScene') boot.changeScene('BootScene')
        currentMenu.value = 0
        selectedBtn.value = -1
    }
